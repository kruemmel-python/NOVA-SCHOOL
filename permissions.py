...
PERMISSION_DEFINITIONS: tuple[dict[str, str], ...] = (
    ...
    {"key": "ai.use", "label": "Lokale KI-Codehilfe", "category": "KI"},
    {"key": "mentor.use", "label": "Sokratischen KI-Mentor nutzen", "category": "KI"},
    {"key": "teacher.materials.use", "label": "Unterrichtsmaterial mit Agenten erstellen", "category": "KI"},
    ...
    {"key": "curriculum.update", "label": "Signierte Curriculum-Updates importieren", "category": "Lernen"},
...
ROLE_DEFAULTS: dict[str, dict[str, bool]] = {
    ...
    "teacher": {
        ...
        "run.node": True,
        "run.npm": True,
        "playground.manage": True,
        "review.use": True,
        "deploy.use": True,
        "teacher.chat.observe": True,
        "teacher.chat.moderate": True,
        "admin.manage": False,
    },
